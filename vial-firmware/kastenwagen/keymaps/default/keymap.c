...
[0] = LAYOUT_1840(
    ...
    KC_ESC ,KC_Q   ,KC_W   ,KC_E   ,KC_R   ,KC_T   ,KC_Y   ,KC_U   ,KC_I   ,KC_O   ,KC_P   ,KC_LBRC,KC_BSPC      , KC_P7  ,KC_P8  ,KC_P9  ,KC_MUTE,
     LT(2, KC_TAB)  ,KC_A   ,KC_S   ,KC_D   ,KC_F   ,KC_G   ,KC_H   ,KC_J   ,KC_K   ,KC_L   ,KC_SCLN,LT(2, KC_QUOT),MO(1)     , KC_P4  ,KC_P5  ,KC_P6  ,KC_PSCR,
    KC_LSFT      ,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_SLSH,KC_ENT ,KC_UP , KC_P1  ,KC_P2  ,KC_P3  ,KC_PAST,
    KC_LCTL  ,KC_LALT  ,MO(2)  ,L2_SPC               ,L3_SPC           ,MO(3)  ,MO(3)  ,KC_RGUI   ,KC_LEFT,KC_DOWN,KC_RGHT,KC_P0  ,KC_PDOT,L3_PENT  
    ),
[1] = LAYOUT_1840(
